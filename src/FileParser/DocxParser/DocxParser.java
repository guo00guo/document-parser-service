...
public class DocxParser {
    ...
    public DocxParser(String docPath) {
...
//        }
    ...
    private void loadFile() {
        try {
            this.stream = new FileInputStream(new File(this.docPath));
    ...
    private DocxParagraph processParagraph(XWPFParagraph paragraph, int index) {
        ...
        for (int i = 0; i < xwpfRuns.size(); i++) {
            ...
            if (i == 0) {
                ...
                if (!color.equals(this.getColor(xwpfRun))) fontName = "";
            }
        }
...
//        }
    ...
    public List<String> getAllParagraphs() {
        ...
        for (DocxParagraph docParagraph : this.docParagraphs) {
            contextList.add(JSON.toJSONString(docParagraph, filter));
        }
        return contextList;
    }
    ...
    public List<String> getAllTables() {
        ...
        for (DocxTable docxTable : this.docxTables) {
            contextList.add(JSON.toJSONString(docxTable, filter));
        }
        return contextList;
    }
    ...
    public List<String> getAllPictures() {
        ...
        for (DocxPicture docxPicture : this.docxPictures) {
            contextList.add(JSON.toJSONString(docxPicture, filter));
        }
        return contextList;
    }
    ...
    private void setPre_type(String pre_type) {
