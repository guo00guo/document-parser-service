...
public class DocParser {
    ...
    public DocParser(String docPath) {
...
//    }
    ...
    public List<String> getAllTables() {
        ...
        for (DocTable docTable : this.docTables) {
            contextList.add(JSON.toJSONString(docTable, filter));
        }
        return contextList;
    }
    ...
    public List<String> getAllParagraphs() {
        ...
        SimplePropertyPreFilter filter = new SimplePropertyPreFilter();
        filter.getExcludes().add("paragraph");
//        System.out.println("docparagraphs-------------------->" + this.docParagraphs);
    ...
    public List<String> getAllHeads() {
        ...
        for (DocParagraph docParagraph : this.docParagraphs) {
            if (docParagraph.getLvl() < 9) {
                headList.add(JSON.toJSONString(docParagraph, filter));
            }
        }
        return headList;
    }
